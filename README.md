...
If ALLAH gives permission arif will have async mode option together with Document-Object-Model class for being able to run as a html and css driver language
